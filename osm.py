...
medical_Est = ["hospital", "clinic","کلینیک_زیبایی","health_care","دکتر","پزشک","مطب","حکیم" ,"midwife", "dentist", "doctors", "doctor", "beauty-shop", "health", "healthcare", "beutician", "physician", "medical", "healthcare=doctor", "healthcare=dentist", "healthcare=midwife"]
...
def am_q(amenity,lat, lon, radius_meters=10000):
    query = f"""
    [out:json];
    (
